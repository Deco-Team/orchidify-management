...
const ClassRateChart = () => {
  const { getReportClassByRate } = useStatisticApi()
  ...
  useEffect(() => {
    ;(async () => {
      const { data: reportData, error: apiError } = await getReportClassByRate()
      if (reportData) {
